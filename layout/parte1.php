...
<head>
    ...
    <script src="<?php echo $URL;?>/public/templeates/AdminLTE-3.2.0/plugins/code.jquery.com/jquery-3.6.4.min.js"></script>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?php echo $URL;?>" class="brand-link">
            <img src="<?php echo $URL;?>/public/imagenes/H.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
