...
<head>
  ...
  <title>SISTEMA DE VENTAS ICYSPICE (v2)</title>
  
<?php
// Definir la variable $body
$body = true; // Puedes cambiar este valor a false para probar la otra condición

// Verificar si $body está definida y su valor es true o false
...
?>
<center>
  <img src=https://img.freepik.com/foto-gratis/elementos-venta-eventos-cyber-monday_23-2148675059.jpg?size=626&ext=jpg;
width="360px" alt=""
</center>
<br>
  <br>
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../public/templeates/AdminLTE-3.2.0/index2.html" class="h1"><b>ICY</b>SPICE</a>
      <div>
    <div class="card-body">
